...
try:
    ...
    def _lazy_import_sentence_transformers():
        ...
        if SentenceTransformer is None:
            try:
                ...
                print("[OK] SentenceTransformers loaded successfully in app_simple")
    ...
    print("✅ SentenceTransformers lazy loading configured")
except Exception as e:
    SENTENCE_TRANSFORMERS_AVAILABLE = False
    print(f"⚠️ SentenceTransformers configuration failed: {e}")
        ...
        if SENTENCE_TRANSFORMERS_AVAILABLE:
            try:
                ...
                if SentenceTransformer:
                    ...
                    self.embedding_model = None
                    print("⚠️ SentenceTransformers not available - embedding model not initialized")
            except Exception as e:
...
def doctor_login():
    ...
    try:
        ...
        print(f"  is_profile_complete: {doctor.get('is_profile_complete')}")
